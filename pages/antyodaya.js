...
const Antyodaya = ({events}) => {
  ...
  return (
    ...
    <div className='md:mx-20 lg:mx-44 '>
      <div>
        <Image src="/3.jpeg" className='object-fill w-full ' width={1200} height={550}></Image>
      </div>
  ...
  <div className="container px-5 lg:px-14 py-12 mx-auto">
    <div className="flex flex-wrap -m-4">
      {events.map((item)=>{
        ...
        <Image src={item.image.asset.url} className='object-fill aspect-auto' width={1200} height={700}></Image>
        </div>
          <div className="p-6">
