...
<div className="flex flex-wrap ">
      <div className="lg:w-1/3 w-full p-2 ">
        <div className="border-2 border-teal-200 p-2 h-full rounded-2xl hover:bg-teal-400 hover:text-white">
...
<div className="flex flex-wrap mt-4 ">
      <div className="lg:w-1/3 w-full p-2 ">
        <div className="border-2 border-teal-200 p-2 h-full rounded-2xl hover:bg-teal-400 shadow-inner hover:text-white">
          <h2 className="text-2xl md:text-3xl text-gray-800 font-medium title-font mb-2 text-center italic ">Dr. Rajeev Tripathi</h2>
          {/* <div className='px-48 lg:visible invisible'><div className="h-1 w-20 bg-teal-600  rounded "></div></div> */}
      ...
      <div className="lg:w-1/3 w-full p-2 ">
        <div className="border-2 border-teal-200 p-2 h-full rounded-2xl hover:bg-teal-400 shadow-inner hover:text-white">
          <h2 className="text-2xl md:text-3xl text-gray-800 font-medium title-font mb-2 text-center italic">Dr. Basant Kumar</h2>
          {/* <div className='px-48 lg:visible invisible'><div className="h-1 w-20 bg-teal-600  rounded "></div></div> */}
          {/* <div className="h-1 md:ml-20 w-28 bg-teal-600 rounded "></div> */}
      ...
      <div className="lg:w-1/3 w-full p-2 ">
        <div className="border-2 border-teal-200 p-2 h-full rounded-2xl hover:bg-teal-400 shadow-inner hover:text-white">
          <h2 className="text-2xl md:text-3xl text-gray-800 font-medium title-font mb-2 text-center italic">Dr. Ranvijay</h2>
          {/* <div className='px-48 lg:visible invisible'><div className="h-1 w-20 bg-teal-600  rounded "></div></div> */}
